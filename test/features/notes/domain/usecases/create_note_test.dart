...
void main() {
  ...
  group('CreateNote', () {
    ...
    test('should return Failure(EmptyTitleFailure) when title is empty', () async {
      ...
      verifyNever(() => mockRepository.create(title: any(named: 'title'), content: any(named: 'content')));
    });
    ...
    test('should call repository and return Success(NoteEntity) when title is valid', () async {
      when(
        () => mockRepository.create(title: any(named: 'title'), content: any(named: 'content')),
