...
void main() {
  ...
  group('HomeCubit', () {
    test('initial state is HomeInitial', () {
      final cubit = HomeCubit(mockGetNotesUseCase);
    ...
    blocTest<HomeCubit, HomeState>(
      ...
      build: () => HomeCubit(mockGetNotesUseCase),
      setUp: () {
        when(() => mockGetNotesUseCase.execute()).thenAnswer((_) async => Success([tNote]));
      },
    ...
    blocTest<HomeCubit, HomeState>(
      ...
      build: () => HomeCubit(mockGetNotesUseCase),
      setUp: () {
        when(() => mockGetNotesUseCase.execute()).thenAnswer((_) async => const Success([]));
      },
      act: (cubit) => cubit.loadNotes(),
    ...
    blocTest<HomeCubit, HomeState>(
      ...
      build: () => HomeCubit(mockGetNotesUseCase),
      setUp: () {
        when(() => mockGetNotesUseCase.execute()).thenAnswer((_) async => const Failure(NoteFirestoreFailure()));
      },
      act: (cubit) => cubit.loadNotes(),
